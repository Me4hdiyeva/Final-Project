  ...
  return (
    <>
      <div className="lists">
        ...
        <div>
          <button onClick={() => handleClick(0)}>1.What is a cryptocurrency exchange?</button>
        ...
        <div>
          <button onClick={() => handleClick(1)}>2.What products does Binance provide?</button>
        ...
        <div>
          <button onClick={() => handleClick(2)}>3.How to buy Bitcoin and other cryptocurrencies on Binance</button>
        ...
        <div>
          <button onClick={() => handleClick(3)}>4.How to track cryptocurrency prices</button>
        ...
        <div>
          <button onClick={() => handleClick(4)}>
           5. How to trade cryptocurrencies on Binance</button>
