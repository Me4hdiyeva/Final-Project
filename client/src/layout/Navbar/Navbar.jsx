            ...
            <>
                <div className="navbar">
                    <div className="right-menu">
                        ...
                        <ul className='scrollbar flex !overflow-x-scroll max-w-[600px] !gap-[20px] lg:overflow-x-auto lg:!max-w-none lg:!gap-[30px] lg:!mx-10'>
                            <li>
                                <Link to={"/buyCrypto"}>
                                    Buy Crypto
                                </Link>
                    ...
                    <div className="left-menu">
                        ...
                        <Link className='whitespace-nowrap' to={"/register"}>
