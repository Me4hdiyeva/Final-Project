...
function Sidebar() {
    ...
    const { status, setStatus, handleSidebar, sidebar } = useContext(STATUS);
    ...
    return (
        <div
            ...
            className='fixed transition-all top-0 bottom-0 right-0 max-w-[600px] w-full bg-white'>
            <div className="">
                <i onClick={handleSidebar} className="fa-solid fa-xmark text-[40px]"></i>
            </div>
            <div className="navbar text-left !items-stretch flex flex-col gap-2">
                <div className="">
                    <Link to={""}>
                        <img
                ...
                <div className="flex flex-col gap-[10px]">
                    <button onClick={logoutFunk} style={{ padding: 10, backgroundColor: "#CFAF30" }}>
                        Log out
                    </button>


                    <div className="flex gap-[5px]">
                        <i class="text-[25px] fa-solid fa-globe"></i>
                        <i class="text-[25px] fa-solid fa-square-caret-down"></i>
                        {
                            status && <>
                                <Link to={"/dashboard"}>
                                    <i class="text-[25px] fa-solid userMain fa-user"></i>
                                </Link>
                                <Link to={"/dashboard/settings"}>
                                    <i class="text-[25px] fa-solid fa-gear"></i>
                                </Link>
                            </>
                        }
                        {/* <Mode /> */}
